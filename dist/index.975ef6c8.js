...
let selectData = [];
const select = new (0, _slimSelectDefault.default)({
    select: ".breed-select",
    data: selectData
});
const refs = {
...
function notiflixCallErrorMessage() {
    (0, _notiflixDefault.default).Notify.failure(`${errorMessage}`);
}
showLoader();
(0, _fetch.fetchBreeds)().then((cats)=>{
    hideLoader();
...
function handleCatSelect() {
    ...
    showLoader();
    (0, _fetch.fetchCatByBreed)(breedId).then((catData)=>{
        hideLoader();
...
},{"./js/fetch":"3MHo1","./sass/index.scss":"9OQSl","notiflix":"5z0Oc","slim-select":"lzHUr","slim-select/dist/slimselect.css":"6O4cs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3MHo1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function fetchCatByBreed(breedId) {
    ...
    return fetch(urlId, options).then((response)=>{
        if (!response.ok) throw new Error(response.status);
        return response.json();
    }).catch((error)=>{
...
},{}],"9OQSl":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"6O4cs":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequireabb0")
